...
All about pets! is a real-time multiplayer game about responsible pet care. Players join a shared game, choose pet avatars, then answer a fresh set of multiple-choice questions about a selected pet and care topic. Each game includes timed rounds, live answer tallies, and a final leaderboard.
