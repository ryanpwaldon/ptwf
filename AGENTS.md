...
- Never add AI attribution or co-authored-by mentions in git commits or code comments
- All git commit messages should be lowercase, unless uppercase is necessary to reference something by its actual name (e.g. package names like Next.js, filenames like README.md)
